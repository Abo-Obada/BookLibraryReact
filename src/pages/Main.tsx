...
import InfinateScroll from "../components/layouts/InfinateScroll";
...
export default function Main() {
  ...
  return (
    ...
    <div className="grid grid-cols-1">
      ...
      <div className="">
        {isPending ? (
        <InfinateScroll scrollDirection="left">
          {
            Array.from({length:10}).map(n=>(
              <Skeleton.Node style={{width:"300px", marginRight:"20px", marginLeft:"20px"}} active={true}/>
            ))
           }
        </InfinateScroll>
      ) : (
              ...
              <InfinateScroll scrollDirection="right">
                {data && data.map((n) => (
                  <DisplayBooks 
                  uuid={n.uuid}
                  views={n.views}
